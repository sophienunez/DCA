export var FooterAttributes;
(function (FooterAttributes) {
    FooterAttributes["nintendologo"] = "nintendologo";
    FooterAttributes["iconfacebook"] = "iconfacebook";
    FooterAttributes["icontwitter"] = "icontwitter";
    FooterAttributes["iconyoutube"] = "iconfacebook";
...
class Footer extends HTMLElement {
    ...
    static get observedAttributes() {
        return Object.keys(FooterAttributes);
    }
    connectedCallback() {
        this.render();
    }
    ...
    render() {
        ...
        <section class="brandbar">
            <div class="brand-wrapper">
                <a href="#" class="nintendo-logo"><svg viewBox="0 0 97 24" width="195" size="195" color="currentColor">
                        <path
                            d="${this.nintendologo}"
                            fill="currentColor"></path>
                    </svg>
                </a>
                <a href="#"><svg viewBox="0 0 32 32" width="30" size="30" color="currentColor">
                        <path
                            d="${this.iconfacebook}"
                            fill="currentColor"></path>
                    </svg>
