export var NavbarAttributes;
(function (NavbarAttributes) {
    NavbarAttributes["logo"] = "logo";
    NavbarAttributes["iconsearch"] = "iconsearch";
    NavbarAttributes["iconsupport"] = "iconsupport";
    NavbarAttributes["iconheart"] = "iconheart";
    NavbarAttributes["iconcart"] = "iconcart";
    NavbarAttributes["login"] = "login";
            ...
            <div class="topstyles">
                <div class="navleft">
                    <a href="#" class="buttonlink">
                        <div class="logo">
                            <span class="logotitle">Nintendo</span>
                            <svg viewBox="0 0 97 24" width="69" role="presentation" alt="" size="69" color="currentColor">
                                <path
                                    d="${this.logo}"
                    ...
                    <div class="search">
                        <button class="search-btn">
                            <svg viewBox="0 0 32 32" class="search-icon" width="18" size="18" color="currentColor">
                                <path
                                    d="${this.iconsearch}"
                                    fill="currentColor"></path>
                            </svg><span>Search games, hardware, news, etc</span>
                        </button>
                        <div class="categories">
                            <select class="categories-selector">
                ...
                <div class="navright">
                    <a href="#" class="navbtn">
                        <span class="navbtn-svg">
                            <svg viewBox="0 0 32 32" width="18" size="18" color="currentColor">
                                <path
                                    d="${this.iconsupport}"
                                    fill="currentColor" fill-rule="evenodd"></path>
                            </svg>
                        </span>
                        <span class="navbtn-text">Support</span>
                    </a>
                    <a href="#" class="navbtn">
                        <span class="navbtn-svg">
                            <svg viewBox="0 0 32 32" width="18" size="18" color="currentColor">
                        ...
                        <span class="navbtn-text">Wish List</span>
                    </a>
                    <a href="#" class="navbtn">
                        <span class="navbtn-svg">
                            <svg viewBox="0 0 32 32" width="18" size="18" color="currentColor">
                        ...
                        <span class="navbtn-text">Cart</span>
                    </a>
                    <a href="#" class="navbtn">
                        <span class="navbtn-svg">
                            <svg viewBox="0 0 32 32" width="18" size="18" color="currentColor">
                        ...
                        <span class="navbtn-text">Log in / Sign up</span>
                    </a>
                </div>
            </div>
                ...
                <div class="bottom-wrapper">
                    <div class="menu">
                        <button class="menubtn">
                            <span class="menubtn-svg">
                                <svg viewBox="0 0 32 32" width="16" size="16" color="currentColor">
                                    <path
                            ...
                            <span class="menubtn-text">My Nintendo Store</span>
                            <span class="menubtn-arrow">
                                <svg viewBox="0 0 32 32" width="12" size="12" color="currentColor">
                                    <path d="M27.7 5.3L32 9.8 16 26.7 0 9.8l4.3-4.5L16 17.7z" fill-rule="evenodd"
                        ...
                        <button class="menubtn">
                            ...
                            <span class="menubtn-text">Games</span>
                            <span class="menubtn-arrow">
                                <svg viewBox="0 0 32 32" width="12" size="12" color="currentColor">
                                    <path d="M27.7 5.3L32 9.8 16 26.7 0 9.8l4.3-4.5L16 17.7z" fill-rule="evenodd"
                                        clip-rule="evenodd" fill="currentColor"></path>
                        ...
                        <button class="menubtn">
                            ...
                            <span class="menubtn-text">Nintendo Switch</span>
                            <span class="menubtn-arrow">
                                <svg viewBox="0 0 32 32" width="12" size="12" color="currentColor">
                                    <path d="M27.7 5.3L32 9.8 16 26.7 0 9.8l4.3-4.5L16 17.7z" fill-rule="evenodd"
                                        clip-rule="evenodd" fill="currentColor"></path>
                        ...
                        <button class="menubtn">
                            ...
                            <span class="menubtn-text">News & Events</span>
                            <span class="menubtn-arrow">
                                <svg viewBox="0 0 32 32" width="12" size="12" color="currentColor">
                                    <path d="M27.7 5.3L32 9.8 16 26.7 0 9.8l4.3-4.5L16 17.7z" fill-rule="evenodd"
                                        clip-rule="evenodd" fill="currentColor"></path>
                        ...
                        <button class="menubtn">
                            ...
                            <span class="menubtn-text">Play Nintendo</span>
                            <span class="menubtn-arrow">
                                <svg viewBox="0 0 32 32" width="12" size="12" color="currentColor">
                                    <path d="M27.7 5.3L32 9.8 16 26.7 0 9.8l4.3-4.5L16 17.7z" fill-rule="evenodd"
                                        clip-rule="evenodd" fill="currentColor"></path>
