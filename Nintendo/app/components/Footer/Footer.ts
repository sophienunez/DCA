...
class Footer extends HTMLElement {
    ...
    static get observedAttributes(): FooterAttributes[] {
        return Object.keys(FooterAttributes) as FooterAttributes[];
    }
    ...
    attributeChangedCallback( prop: FooterAttributes, _: string, newValue: string): void{
        this[prop] = newValue;
        this.render();
    }
