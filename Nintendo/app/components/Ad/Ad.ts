...
class Ad extends HTMLElement {
    ...
    static get observedAttributes(): AdAttributes[] {
        return Object.keys(AdAttributes) as AdAttributes[];
    }
    ...
    attributeChangedCallback( prop: AdAttributes, _: string, newValue: string): void{
        this[prop] = newValue;
        this.render();
    }
